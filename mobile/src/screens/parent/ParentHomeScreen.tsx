...
function createStyles(colors: import('../../theme/colors').ColorPalette) {
  return StyleSheet.create({
    ...
    avatarLargeText: { fontSize: 18, fontWeight: '700', color: colors.avatarText },
    headerText: { marginLeft: 14 },
    headerName: { fontSize: 18, fontWeight: '700', color: colors.text },
    headerClass: { fontSize: 14, color: colors.textMuted, marginTop: 2 },
    roleTag: {
    ...
    roleTagText: { fontSize: 12, fontWeight: '600', color: colors.primary },
    ...
    childChipTextActive: { color: colors.primary, fontWeight: '600' },

  ...
  const save = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingId) {
        ...
        setEditingId(null);
        setForm({ name: '', address: '', contactEmail: '', contactPhone: '', principalEmail: '', principalDisplayName: '', principalPassword: '' });
        setShowForm(false);
      } else {
        ...
        setSchools((prev) => [...prev, { id: schoolId, ...data, createdAt: now } as School]);
        setForm({ name: '', address: '', contactEmail: '', contactPhone: '', principalEmail: '', principalDisplayName: '', principalPassword: '' });
        setShowForm(false);
      }
    } catch (err: unknown) {
